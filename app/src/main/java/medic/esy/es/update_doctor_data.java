...
public class update_doctor_data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_number=(EditText)findViewById(R.id.update_number_doctor);
        update_address=(EditText)findViewById(R.id.update_address_doctor);
        update_data=(TextView)findViewById(R.id.update_data_doctor);
                    ...
                    myref.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
...

                            {
                                ...
                                Intent i = new Intent(update_doctor_data.this, DoctorProfile.class);
                                startActivity(i);
                            }
